	...
	return (
		<>
			...
			<div className=" min-h-[20vh] grid grid-cols-4 container mx-auto gap-5 w-1/2">
				<div className="bg-blue-200 rounded shadow w-full h-full pt-5 flex align-middle justify-center flex-col items-center mx-auto border-8 border-red-400">
					<SiHtml5 size={55} />
				...
				<div className="bg-blue-200  rounded shadow w-full   h-full pt-4 flex align-middle justify-center flex-col items-center mx-auto border-8 border-red-400">
					<SiBootstrap size={55} />
